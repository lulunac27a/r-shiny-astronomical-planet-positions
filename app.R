...
ui <- fluidPage(titlePanel("Astronomical Planet Positions with Rise and Set Times and Sun"),
    sidebarLayout(sidebarPanel(sliderInput("date", "Day of Year",
        ...
        mainPanel(textOutput("dateTime"), textOutput("sunPosition"),
            textOutput("sunRiseSet"), textOutput("planetPosition"),
            textOutput("planetRiseSet"), textOutput("sunAltitudeAzimuth"),
